...
class PyTorchEfficientNetV2InferenceTool(Tool):

    name = "pytorch_efficientnetv2_inference"
    description = """
    This tool uses a trained PyTorch EfficientNetV2 model to perform inference on new images.
    ...
    inputs = {
        ...
        "model_variant": {
            "type": "string",
            "description": "EfficientNetV2 variant",
            "required": False,
            "nullable": True
        },
        "batch_size": {
        ...
        "use_custom_image_size": {
            "type": "boolean",
            "description": "Whether to use a custom image size",
            "required": False,
            "nullable": True
        },
        "custom_image_size": {
            "type": "integer",
            "description": "Custom image size to use",
            "required": False,
            "nullable": True
        }
    }
    ...
    def forward(
        ...
        """
        Run inference using a trained PyTorch EfficientNetV2 model on new images.
        ...
        Args:
            ...
            model_variant: EfficientNetV2 variant (will use config value if not specified)
        ...
        try:
            ...
            if model_variant is None:
                model_variant = model_config.get('model_variant', 'efficientnet_v2_s')
            ...
            if use_custom_image_size:
                ...
                # Use config image size or default for the variant
                ...
                if image_size is None:
                    ...
                    image_size = default_sizes.get(model_variant, 384)

            efficientnet_image_size = (image_size, image_size)

            # Log inference settings
            logging.info(f"Starting EfficientNetV2 inference with settings:")
            ...
            # Dictionary of available EfficientNetV2 models
            efficientnet_models = {
            ...
            model_fn = efficientnet_models[model_variant]
            ...
            if ground_truth_file and os.path.exists(ground_truth_file):
                ...
                # Rename columns in ground truth file if needed
            ...
            with torch.no_grad():
                for batch_idx, batch_data in enumerate(data_loader):
                    if has_labels:
                        ...
                        batch_filenames = [dataset.labels_df.iloc[i]['filename']
                ...
                try:
                    ...
                    for class_idx in unique_classes:
                        ...
                        if class_key in class_report:
                            ...
                            metrics[f'precision_class_{class_idx}'] = class_metrics['precision']
                            metrics[f'recall_class_{class_idx}'] = class_metrics['recall']
                            metrics[f'f1_class_{class_idx}'] = class_metrics['f1-score']
                            metrics[f'support_class_{class_idx}'] = class_metrics['support']

                            # Calculate sensitivity and specificity for each class
                            # Sensitivity = recall
                            metrics[f'sensitivity_class_{class_idx}'] = class_metrics['recall']
